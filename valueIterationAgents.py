    ...
    def __init__(self, mdp, discount = 0.9, iterations = 100):
        """
          ...
          Some useful mdp methods you will use:
              mdp.getStates() = list of coordinates
              mdp.getPossibleActions(state) = list of possible actions from state
              mdp.getTransitionStatesAndProbs(state, action) = (s', T(s,a,s') )
              mdp.getReward(state, action, nextState) = reward value
              mdp.isTerminal(state) = Boolean 
        """
        self.mdp = mdp
        ...
        # next = mdp.getTransitionStatesAndProbs(states[2], actions[1])[1][1]
        # print mdp.getReward(states[2], actions[1], next)
        # print mdp.isTerminal(states[2])
          ...
          for state in states:
            ...
            if len(possibleActions) == 0:
              ...
              for action in possibleActions:
                ...
                value = max(value, currentQvalue)
              prevValues[state] = value
